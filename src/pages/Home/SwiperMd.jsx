...
import {SwiperDetailsLg} from "./SwiperDetailsLg";
import {SwiperDetailsMd} from "./SwiperDetailsMd";
                    ...
                    sliderDetails.map((item, index) => {
                        return (
                            <SwiperSlide key={index.toString()} className={'slider-pic rounded-4'}
                                         style={{backgroundImage: `url(${item.right_image?.desktop_webp_url})`, minHeight: '350px', backgroundRepeat: 'no-repeat'}}>
                                <SwiperDetailsMd item={item}/>
                            </SwiperSlide>
                        )
                    })
                }
